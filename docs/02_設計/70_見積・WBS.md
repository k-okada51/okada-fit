...
| W-08 | 機能 | FEAT-01 器具登録（RPC 3本＋画面＋**ジム/種目の即時作成ダイアログ**） | 実装者 | 2〜3日 `[仮]` | W-03 | AC を満たす。画面遷移せず登録できる |
| W-09 | 機能 | FEAT-02 部位選択と器具絞り込み | 実装者 | 1日 `[仮]` | W-08 | **5値すべてで絞り込める**（`06_DB設計規約.md §8`） |
| W-10 | 機能 | FEAT-10 食事マスタCSVインポート**＋食品一覧の編集・削除** | 実装者 | 2〜3日 `[仮]` | W-03 | Shift_JIS・UTF-8 の両方が通る。食品を1件ずつ直せる |
...
**合計 18〜25人日** `[仮]`（W-01・W-02 を除く。2026-08-22 の UI導線決定で W-10 が +0.5〜1日）。
